...
1. Upload your solar export CSV (hourly, 15-minute or daily).
...
> Note: the legacy Flask UI (`app.py` + `templates/`) has been removed. `app.py` now only
> exposes an optional API and is not used by the static site.
